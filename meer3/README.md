...
14. Now that the drive is ready, download the `firmware.rom` file from here: [meer3 firmware](firmware.rom). Click `Download` to begin the download of the firmware.
