...
14. Now that the drive is ready, download the `firmware.bio` file from here: [meer3 firmware](firmware.bio). Click `Download` to begin the download of the firmware.
