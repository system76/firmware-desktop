...
14. Now that the drive is ready, download the `firmware.rom` file from here: [meer2 firmware](firmware.rom). Click `Download` to begin the download of the firmware.
...
8. Select the `firmware.rom` file and hit "Enter" on your keyboard.
9. A blue pop-up will appear. You will then be asked "Are you sure you wish to udate the BIOS with "firmware.rom?". Hit "Enter" once again to confirm.
